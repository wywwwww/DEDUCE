...
class SequentialCIFAR100(ContinualDataset):
    ...
    def get_scheduler(model, args) -> torch.optim.lr_scheduler:
        model.module.opt = torch.optim.SGD(model.module.net.parameters(), lr=args.lr, weight_decay=args.optim_wd, momentum=args.optim_mom)
        scheduler = torch.optim.lr_scheduler.MultiStepLR(model.module.opt, [35, 45], gamma=0.1, verbose=False)
        return scheduler
